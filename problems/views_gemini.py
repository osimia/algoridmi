...
def _get_estimated_time(score):
    """Определяет примерное время решения в минутах"""
    if score <= 300:
        return "2-3 минуты"
    elif score <= 600:
        return "3-5 минут"
